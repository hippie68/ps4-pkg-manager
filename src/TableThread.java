...
public class TableThread extends Thread {
    ...
    public void run() {
        while (true) {
            Object o = queue.pop(); // Either of type String (path to a PKG file) or PS4PKG.
            final PS4PKG pkg;

            if (o instanceof String) {
                String path = (String) o;
                try {
                    // TODO: warning when files are not PS4 PKGs.
                    pkg = new PS4PKG(path);
                } catch (Exception e) {
                    System.err.println("File name: " + path);
                    e.printStackTrace();
                    continue; // TODO: handle "not a PS4 PKG" and I/O errors differently; ignore non-PKG
